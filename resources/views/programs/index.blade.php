            ...
            <div id="program-panel-{{ $program->id }}" class="program-panel {{ $loop->first ? 'block' : 'hidden' }} mt-12">
                <div class="grid md:grid-cols-2 gap-10 items-center">
                    <div>
                        ...
                        <a href="{{ route('registration.create', ['program' => $program->slug]) }}" class="inline-flex items-center bg-emerald-600 text-white px-6 py-3 rounded-full font-semibold shadow hover:bg-emerald-700 transition">
                            Daftar Program Ini
